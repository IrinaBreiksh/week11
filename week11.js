...
function makeTwelve() {
    const divBlue = document.querySelector('.resizeable');
	// divBlue.style.width = '400px';	
	// divBlue.style.height = '200px';
	divBlue.classList.toggle('large');
}
...
//Если задание выполнено верно, то вы увидите, что все элементы <p> на странице, в том числе и задания, изменили свои значения.  Чтобы вернуть всё, как было до выполнения задания, перезагрузите страницу.
...
function makeFifteen() {
	const divToDeleteClass = document.getElementById('practicum15');
	divToDeleteClass.classList.remove('practicum15');
}
...
function makeSixteen() {
	const divToAddClass = document.getElementById('practicum16');
	divToAddClass.classList.add('practicum16');
}
...
function makeSeventeen() {
	const divColorChange = document.getElementById('practicum17');
	divColorChange.classList.toggle('color');
}
...
function makeEighteen() {
	const divChangeSmth = document.getElementById('practicum18');
	divChangeSmth.classList.toggle('active');
}
